...
#### Расширенная аналитика по группе. Добавить в класс Group аналитический метод, собирающий статистику по студентам.
...
class Group:
    ...
    def stats(self) -> dict:
        ...
        if not processed_data:
            return{
                "count": 0, "min_gpa": 0.0, "max_gpa": 0.0, "avg_gpa": 0.0,
                "groups": {}, "top_5_students": [] 
            }
...
## Initial CSV file
![Inicial_students](../../images/lab09/CSV_students_After.png)

## Outputs
![Outputs](../../images/lab09/CLI_results.png)

## final CSV file

![Final_students](../../images/lab09/CSV_students_Befor.png)
